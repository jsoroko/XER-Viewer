...
export function Welcome({ loading, error, onFile, onSample }: Props) {
  ...
  return (
    <div className="flex h-full flex-col overflow-auto">
      ...
      <footer className="flex shrink-0 items-center justify-center gap-2 px-6 py-4 text-xs text-slate-500 dark:text-slate-400">
        Designed by Jacek Soroko
        <a
          href="https://www.linkedin.com/in/jacek-soroko-059a6254"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Jacek Soroko on LinkedIn"
          title="Jacek Soroko on LinkedIn"
          className="inline-flex rounded text-slate-500 hover:text-accent-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/40 dark:text-slate-400 dark:hover:text-accent-400"
        >
